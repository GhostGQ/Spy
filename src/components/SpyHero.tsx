    ...
    <Svg width={size} height={size} viewBox="0 0 240 240">
      <Defs>
        <RadialGradient id="halo" cx="50%" cy="50%" r="50%">
          <Stop offset="0%" stopColor="#2DD4F7" stopOpacity={0.35} />
          <Stop offset="55%" stopColor="#3B82F6" stopOpacity={0.12} />
          <Stop offset="100%" stopColor="#3B82F6" stopOpacity={0} />
        </RadialGradient>
        <RadialGradient id="disc" cx="50%" cy="42%" r="70%">
          <Stop offset="0%" stopColor="#222a55" />
          <Stop offset="100%" stopColor="#11132b" />
        </RadialGradient>
        <LinearGradient id="hat" x1="0" y1="0" x2="0" y2="1">
          <Stop offset="0%" stopColor="#2A2F5A" />
          <Stop offset="100%" stopColor="#171a38" />
        </LinearGradient>
        <LinearGradient id="band" x1="0" y1="0" x2="1" y2="0">
          <Stop offset="0%" stopColor="#3B82F6" />
          <Stop offset="100%" stopColor="#2DD4F7" />
        </LinearGradient>
      ...
      {/* HUD rings */}
      <Circle cx={120} cy={120} r={100} stroke="#60A5FA" strokeOpacity={0.18} strokeWidth={1.5} fill="none" strokeDasharray="2 12" />
      <Circle cx={120} cy={120} r={92} stroke="#60A5FA" strokeOpacity={0.22} strokeWidth={2} fill="none" />
      <Circle
        cx={120}
        cy={120}
        r={92}
      ...
      {/* badge disc */}
      <Circle cx={120} cy={120} r={78} fill="url(#disc)" stroke="#3B82F6" strokeOpacity={0.45} strokeWidth={1.5} />

      {/* spy emblem */}
      <G>
        {/* hat brim */}
        <Ellipse cx={120} cy={116} rx={56} ry={12} fill="#13162f" />
        ...
        {/* face */}
        <Path d="M94 116 H146 V150 a26 26 0 0 1 -52 0 Z" fill="#0c0f24" />
        ...
        />
        {/* eyes */}
        <Circle cx={110} cy={132} r={3} fill="#0c0f24" />
        <Circle cx={132} cy={132} r={3} fill="#0c0f24" />
      </G>
    </Svg>
  );
}
